...
//{
//	sl::ShaderMgr::Instance()->GetContext()->BindRenderTarget(id);
//}
//
//static int _get_target()
//{
//	return sl::ShaderMgr::Instance()->GetContext()->GetCurrRenderTarget();
//}
//
...
//	//}
//
//	//return RenderContext::Instance()->GetImpl()->CreateTexture(static_cast<const uint8_t*>(data), width, height, format);
//
//	return 0;
//}
//
...
//	RenderContext::Instance()->GetImpl()->ReleaseTexture(id);
//}
//
//static void
//_texture_update(const void* pixels, int w, int h, unsigned int id) {
//	RenderContext::Instance()->GetImpl()->UpdateTexture(static_cast<const uint8_t*>(pixels), w, h, id);
//}
//
//static void
//_sub_tex_update(const void* pixels, int x, int y, int w, int h, unsigned int id) {
//	RenderContext::Instance()->GetImpl()->UpdateSubTexture(static_cast<const uint8_t*>(pixels), x, y, w, h, id);
//}
//
//static int
//_texture_id(int id) {
